...
<div class="container" style="margin-top: 120px">
	<div class="panel panel-default panelnth">
		<div class="panel-body">
			<html:form action="danhsachkhachhang.do" styleId="formm" method="GET">
				<div class="form-group btn-group rightnth col-sm-4">
				<div class="btn col-sm-4"><html:submit
					styleClass="btn btn-primary rightnth"></html:submit></div>
				<div class="btn col-sm-7"><html:text
					styleClass="form-control rightnth" name="listKhachHangForm" property="search"></html:text></div>
				<div class="btn col-sm-1"><span
				...
				<table class="table table-hover">
					...
					<tbody>
						<logic:iterate name="listKhachHangForm" property="listKH" id="kh">
							<tr>
								<th scope="row"><bean:write name="kh" property="userName" /></th>
								<td><bean:write name="kh" property="sDT" /></td>
								<td><bean:write name="kh" property="diaChi" /></td>
								<td><logic:equal name="kh" property="gioiTinh" value="1">
										Nam
									</logic:equal> <logic:equal name="kh" property="gioiTinh" value="0">
										Nữ
									</logic:equal></td>
								<td><bean:write name="kh" property="ngaySinh" /></td>
								<td><bean:write name="kh" property="email" /></td>
								<td><bean:define id="msv" name="kh" property="userName"></bean:define>
									<html:link action="/suaTT?userName=${msv}" style="margin-left: 30px;">
										<span class="glyphicon glyphicon-edit"></span>
									</html:link> <html:link action="/xoaTT?userName=${msv}" onclick="return confirmdel()" style="margin-left: 30px;">
